...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      TesterSelenium tester = new TesterSelenium();
      ...
      log.getPassedFailed(lineList.size(), tester.getFail());
