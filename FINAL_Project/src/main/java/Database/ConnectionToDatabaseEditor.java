...
/**
 * Connection to database wordpress for editor
 */
public class ConnectionToDatabaseEditor {
  ...
  private String ADDING_EDITOR = "INSERT INTO wordpress.wp_users (user_login, user_pass, user_nicename, user_email, display_name) " +
  ...
  private String DELETE_ROLE_EDITOR = "DELETE FROM wordpress.wp_usermeta" +
      " WHERE user_id = (SELECT ID FROM wp_users WHERE user_login = 'editor')";
  private String DELETE_DRAFT = "DELETE FROM wordpress.wp_posts " +
      "WHERE post_author = (SELECT ID FROM wp_users WHERE user_login = 'editor')";
  private String DELETE_AUTO_DRAFT = "DELETE FROM wordpress.wp_posts " +
      "WHERE post_author = (SELECT ID FROM wp_users WHERE user_login = 'editor') AND post_title = 'Auto Draft'";
